...
const variantStyles = {
  primary: 'bg-gold-400 text-mag-black hover:bg-gold-500 font-semibold',
  secondary: 'bg-mag-dark border border-mag-border text-white hover:border-gold-400/50',
  ghost: 'bg-transparent text-mag-muted hover:text-white hover:bg-mag-dark',
